...
use galaxybook_camera::{
    ...
    spawn_camera_worker, timestamp, video_library_dir, APP_ID, APP_NAME,
    AudioSourceOption, CameraConfig, CaptureMode, OwnedFrame, Preset, SingletonState,
    VideoEncoderBackend, WorkerCommand, WorkerEvent,
};
use adw::prelude::*;
use gtk::gdk;
...
struct ControlWidgets {
    auto_apply_row: adw::SwitchRow,
    show_grid_row: adw::SwitchRow,
    ...
    exposure_scale: gtk::Scale,
    exposure_value: gtk::Label,
    contrast_scale: gtk::Scale,
    contrast_value: gtk::Label,
    saturation_scale: gtk::Scale,
    saturation_value: gtk::Label,
    hue_scale: gtk::Scale,
    hue_value: gtk::Label,
    temperature_scale: gtk::Scale,
    temperature_value: gtk::Label,
    tint_scale: gtk::Scale,
    tint_value: gtk::Label,
    red_scale: gtk::Scale,
    red_value: gtk::Label,
    green_scale: gtk::Scale,
    green_value: gtk::Label,
    blue_scale: gtk::Scale,
    blue_value: gtk::Label,
    gamma_scale: gtk::Scale,
    gamma_value: gtk::Label,
    sharpness_scale: gtk::Scale,
    sharpness_value: gtk::Label,
...
fn build_control_widgets(audio_sources: &[AudioSourceOption]) -> ControlWidgets {
...
fn set_scale_value(scale: &gtk::Scale, label: &gtk::Label, value: f64) {
    scale.set_value(value);
    label.set_label(&format!("{value:.2}"));
}

fn selected_audio_index(options: &[AudioSourceOption], selected_id: &str) -> u32 {
    options
        .iter()
...
fn draw_preview_grid(_area: &gtk::DrawingArea, cr: &gtk::cairo::Context, width: i32, height: i32) {
